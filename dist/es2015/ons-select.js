...
export let OnsSelect = (_dec = customElement('ons-select'), _dec2 = inject(DOM.Element), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = noView(_class = _dec2(_class = (_class2 = class OnsSelect {
