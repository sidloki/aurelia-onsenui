...
System.register(['aurelia-logging', 'aurelia-dependency-injection', 'aurelia-history', 'aurelia-router', 'aurelia-event-aggregator'], function (_export, _context) {
  "use strict";

  var LogManager, Container, inject, History, PipelineProvider, AppRouter, isNavigationCommand, EventAggregator, _dec, _class, logger, OnsRouter;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('OnsRouter', OnsRouter = (_dec = inject(Container, History, PipelineProvider, EventAggregator), _dec(_class = function (_AppRouter) {
