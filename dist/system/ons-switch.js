...
System.register(['aurelia-dependency-injection', 'aurelia-pal', 'aurelia-templating', 'aurelia-binding'], function (_export, _context) {
  ...
  var inject, DOM, customElement, noView, bindable, bindingMode, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, OnsSwitch;
  ...
  return {
    ...
    execute: function () {
      _export('OnsSwitch', OnsSwitch = (_dec = customElement('ons-switch'), _dec2 = inject(DOM.Element), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = noView(_class = _dec2(_class = (_class2 = function () {
