...
System.register(['aurelia-dependency-injection', 'aurelia-pal', 'aurelia-templating'], function (_export, _context) {
  ...
  var inject, DOM, customElement, noView, bindable, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, OnsIcon;
  ...
  return {
    ...
    execute: function () {
      _export('OnsIcon', OnsIcon = (_dec = customElement('ons-icon'), _dec2 = inject(DOM.Element), _dec(_class = noView(_class = _dec2(_class = (_class2 = function () {
